    ...
    <div className="rounded-3xl border border-gray-200 bg-white p-7 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
      ...
      <div className="flex items-center justify-between">
        <div className="flex h-12 w-12 items-center justify-center">
          <img className="h-10 w-10" src={data.icon} alt={data.name} />
        </div>
      ...
      {/* Name */}
      <h2 className="mt-6 text-2xl font-bold text-gray-900">{data.name}</h2>
      ...
      <div className="flex items-center justify-between text-sm">
        ...
        <span className="text-slate-600">{data.difficulty}</span>
